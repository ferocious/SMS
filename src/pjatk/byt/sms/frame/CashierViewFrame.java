...
public class CashierViewFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setText("Nowa Operacja");
        ...
        jButton3.setText("Sprzedaż");

        jButton4.setText("Opcje");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CashierViewFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CashierViewFrame().setVisible(true);
            }
        });
    }
